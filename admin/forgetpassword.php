                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border-0 mb-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form id="regForm" action="Processes/forgetpassword.php" method="post" role="form">
                                <div class="tab">
                                    <div class="form-group">
                                        <label for="exampleInputFName">Enter your Email</label>
                                ...
                                <div class="tab">
                                    <div class="form-group">
                                        <label for="exampleInputFName">Choose The Security Question To Change
                                            Password</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFName">Enter Your Answer</label>
